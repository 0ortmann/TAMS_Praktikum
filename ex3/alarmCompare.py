...
def AlarmCompare(time_mins1, time_mins10, time_hrs1, time_hrs10, alarm_mins1, alarm_mins10, alarm_hrs1, alarm_hrs10, compare):
    ...
    @always_seq(time_mins1.posedge, time_mins10.posedge, time_hrs1.posedge, time_hrs10.posedge, alarm_mins1.posedge, alarm_mins10.posedge, alarm_hrs1.posedge, alarm_hrs10.posedge)
    def alarmCompare():
