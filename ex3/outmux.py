...
def Outmux(sev_seg_digit, select_digit, 
		time_secs1, time_secs10, time_mins1, time_mins10, time_hrs1, time_hrs10, alarm_mins1, alarm_mins10, alarm_hrs1, alarm_hrs10, set_alarm, clk1ms, reset):
	"""
	...
	current_time_digit = Signal(intbv(0, min=0, max=5))
	current_alarm_digit = Signal(intbv(0, min=0, max=3))
